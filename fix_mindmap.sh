...
echo "🚀 Fixing MindMap Project..."

# Create the MindMapDocument.swift with all the modern code
cat > Model/MindMapDocument.swift << 'EOF'
import SwiftUI
import Foundation
...
# Fix the MindMapApp.swift file
cat > MindMapApp.swift << 'EOF'
import SwiftUI
...
# Create the ContentView.swift file
...
rm -rf ~/Library/Developer/Xcode/DerivedData/MindMap*

echo "✅ All files created!"
echo "📁 Files created:"
echo "   - Model/MindMapDocument.swift (modern observable models)"
echo "   - MindMapApp.swift (fixed DocumentGroup)"
echo "   - ContentView.swift (simple test view)"
echo ""
echo "🚀 Next steps:"
echo "   1. Open Xcode"
echo "   2. Add ContentView.swift to your project"
echo "   3. Build and run!"
echo ""
echo "You should see: 'Nodes: 3, Connections: 2' on a black screen"